...
class ActiveLearner:
    """
    use example:
    >>> learner = ActiveLearner(initialization_method=random_sample_init(), n_samples=100)
    >>> sampled_index = learner.add_n_new_samples(x, y , sample_method=random_sample)
    """
    ...
    def initialize_learner(self, x: np.array, y: np.array, raw_sentences, random_init_sample,
